...
Menu, BackupsS3, Add, 🗄️ Borg Backup, OpenFile
Menu, BackupsS3, Add, 🗄️ Restic Backup, OpenFile
...
; ============= Cloud =============
Menu, Cloud, Add, ☁️ AWS CLI, OpenFile
Menu, Cloud, Add, ☁️ Azure CLI, OpenFile
Menu, Cloud, Add, ☁️ GCP CLI, OpenFile
Menu, Cloud, Add, ☁️ OpenStack, OpenFile

; ============= Databases =============
Menu, Databases, Add, 🗄️ Memcached, OpenFile
Menu, Databases, Add, 🗄️ MongoDB, OpenFile
Menu, Databases, Add, 🗄️ MySQL/MariaDB && Cluster, OpenFile
Menu, Databases, Add, 🗄️ OpenSearch, OpenFile
Menu, Databases, Add, 🗄️ Oracle, OpenFile
Menu, Databases, Add, 🗄️ PostgreSQL, OpenFile
Menu, Databases, Add, 🗄️ Redis, OpenFile
Menu, Databases, Add, 🗄️ SQLite, OpenFile

; ============= Dev & Tools =============
Menu, DevTools, Add, 🛠️ Ansible, OpenFile
Menu, DevTools, Add, 🛠️ Build Tools, OpenFile
Menu, DevTools, Add, 🛠️ Git Advanced, OpenFile
Menu, DevTools, Add, 🛠️ Git, OpenFile
Menu, DevTools, Add, 🛠️ Jenkins, OpenFile
Menu, DevTools, Add, 🛠️ Kafka, OpenFile
Menu, DevTools, Add, 🛠️ Node Tools, OpenFile
Menu, DevTools, Add, 🛠️ Python Tools, OpenFile
Menu, DevTools, Add, 🛠️ Terraform, OpenFile
Menu, DevTools, Add, 🛠️ tmux, OpenFile
Menu, DevTools, Add, 🛠️ Zookeeper, OpenFile
...
Menu, InfraMgmt, Add, 🏗️ AWX, OpenFile
Menu, InfraMgmt, Add, 🏗️ Uyuni, OpenFile

; ============= Kubernetes & Containers =============
Menu, K8s, Add, ☸️ Docker, OpenFile
Menu, K8s, Add, ☸️ Helm, OpenFile
Menu, K8s, Add, ☸️ K9s, OpenFile
Menu, K8s, Add, ☸️ kubectl, OpenFile
Menu, K8s, Add, ☸️ kubectl JSONPath, OpenFile
Menu, K8s, Add, ☸️ kubectl Kustomize, OpenFile
Menu, K8s, Add, ☸️ OpenShift, OpenFile
Menu, K8s, Add, ☸️ Podman && nerdctl, OpenFile
...
FileMap(item) {
    ...
    if (files.Count() = 0) {
        ...
        files["🗄️ Borg Backup"]                           := "backups-s3\borgcheatsheet.md"
        files["🗄️ Restic Backup"]                         := "backups-s3\resticcheatsheet.md"
        ; Basics
        ...
        ; Cloud
        files["☁️ AWS CLI"]                               := "cloud\awsclicheatsheet.md"
        files["☁️ Azure CLI"]                             := "cloud\azureclicheatsheet.md"
        files["☁️ GCP CLI"]                               := "cloud\gcpclicheatsheet.md"
        files["☁️ OpenStack"]                             := "cloud\openstackcheatsheet.md"
        ; Databases
        files["🗄️ Memcached"]                             := "databases\memcached-sysadmin.md"
        files["🗄️ MongoDB"]                               := "databases\mongodbcheatsheet.md"
        files["🗄️ MySQL/MariaDB & Cluster"]               := "databases\mysqlcheatsheet.md"
        files["🗄️ OpenSearch"]                            := "databases\opensearchcheatsheet.md"
        files["🗄️ Oracle"]                                := "databases\oraclecheatsheet.md"
        files["🗄️ PostgreSQL"]                            := "databases\postgrescheatsheet.md"
        files["🗄️ Redis"]                                 := "databases\redis_prod_cheatsheet.md"
        files["🗄️ SQLite"]                                := "databases\sqlitecheatsheet.md"
        ; Dev & Tools
        files["🛠️ Ansible"]                               := "dev-tools\ansiblecheatsheet.md"
        files["🛠️ Build Tools"]                           := "dev-tools\buildtoolscheatsheet.md"
        files["🛠️ Git Advanced"]                          := "dev-tools\gitadvancedcheatsheet.md"
        files["🛠️ Git"]                                   := "dev-tools\gitcheatsheet.md"
        files["🛠️ Jenkins"]                               := "dev-tools\jenkinscheatsheet.md"
        files["🛠️ Kafka"]                                 := "dev-tools\kafkacheatsheet.md"
        files["🛠️ Node Tools"]                            := "dev-tools\nodetoolscheatsheet.md"
        files["🛠️ Python Tools"]                          := "dev-tools\pythontoolscheatsheet.md"
        files["🛠️ Terraform"]                             := "dev-tools\terraformcheatsheet.md"
        files["🛠️ tmux"]                                  := "dev-tools\tmuxcheatsheet.md"
        files["🛠️ Zookeeper"]                             := "dev-tools\zookeepercheatsheet.md"
        ; Diagnostics
        ...
        ; Infrastructure Management
        files["🏗️ AWX"]                                   := "infrastructure-mgmt\awxcheatsheet.md"
        files["🏗️ Uyuni"]                                 := "infrastructure-mgmt\uyunicheatsheet.md"
        ; Kubernetes & Containers
        files["☸️ Docker"]                                := "kubernetes-containers\dockercheatsheet.md"
        files["☸️ Helm"]                                  := "kubernetes-containers\helmcheatsheet.md"
        files["☸️ K9s"]                                   := "kubernetes-containers\k9scheatsheet.md"
        files["☸️ kubectl"]                               := "kubernetes-containers\kubectlcheatsheet.md"
        files["☸️ kubectl JSONPath"]                      := "kubernetes-containers\kubectljsonpathcheatsheet.md"
        files["☸️ kubectl Kustomize"]                     := "kubernetes-containers\kubectlkustomizecheatsheet.md"
        files["☸️ OpenShift"]                             := "kubernetes-containers\openshiftcheatsheet.md"
        files["☸️ Podman & nerdctl"]                      := "kubernetes-containers\podmannerdctlcheatsheet.md"
        ; Monitoring
