...
# ⬇️ TAIL — Last Lines /TAIL — Последые строки

### Basic Usage / Базовое использование
tail file                                       # Last 10 lines / Последние 10 строк
tail -n 20 file                                 # Last 20 lines / Последние 20 строк
tail -20 file                                   # Short form / Короткая форма tail -n +10 file                                # From line 10 to end / С 10-й строки до конца
...
# Use tail -f instead of watch for log files / Используйте tail -f вместо watch для логов
