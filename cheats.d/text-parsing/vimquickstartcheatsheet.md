...
- [Modes](#-modes--режимы)
- [Navigation & Movement](#-navigation--movement--навигация-и-перемещения)
- [Marks & Jumps](#-marks--jumps--метки-и-прыжки)
- [Search](#-search--поиск)
- [Replace](#-replace--замены)
- [Editing](#-editing--редактирование)
- [Visual & Block Ops](#-visual--block-ops--операции-в-визуальномблочном-режимах)
- [Registers & Clipboard](#-registers--clipboard--регистры-и-буфер-обмена)
- [Windows (splits)](#-windows-splits--окна-сплиты)
- [Tabs](#-tabs--вкладки)
- [Buffers](#-buffers--буферы)
- [Folding](#-folding--сворачивание)
- [Quickfix & Grep](#-quickfix--grep--окно-результатов-и-поиск-по-файлам)
- [Diff](#-diff--сравнение)
- [Netrw (file browser)](#-netrw-file-browser--файловый-браузер)
- [External & Filters](#-external--filters--внешние-команды-и-фильтры)
- [Sessions & Workdirs](#-sessions--workdirs--сессии-и-каталоги)
- [Indent & Whitespace](#-indent--whitespace--отступы-и-пробелы)
- [Spell](#-spell--орфография)
- [QoL Options](#-qol-options--полезные-опции)
