...
- [Status & Diagnostics](#status-diagnostics-проверка-состояния-дисков-и-lvm)
- [Adding a New Disk](#adding-a-new-disk-добавление-нового-диска)
- [Adding Disk to LVM](#adding-disk-to-lvm-добавление-диска-в-lvm)
- [Extending LV & Filesystem](#extending-lv-filesystem-расширение-логического-тома-и-файловой-системы)
- [Formatting & Mounting](#formatting-mounting-форматирование-и-монтирование)
- [LVM Snapshots](#lvm-snapshots-снапшоты-lvm)
- [Thin Provisioning](#thin-provisioning-тонкое-выделение)
- [Removing Disk from LVM](#removing-disk-from-lvm-удаление-диска-из-lvm)
- [Creating New LVM from Scratch](#creating-new-lvm-from-scratch-создание-нового-lvm-с-нуля)
- [Filesystem Check & Repair](#filesystem-check-repair-проверка-и-ремонт-файловой-системы)
- [Useful Utilities](#useful-utilities-полезные-утилиты)
- [Automation Script](#automation-script-автоматизация-expand_data_storagesh)
- [Error Recovery](#error-recovery-восстановление-при-ошибках)
- [Common Commands Reference](#common-commands-reference-часто-используемые-команды)
- [LVM Architecture Comparison](#lvm-architecture-comparison-сравнение-архитектур-хранения)
