...
# Commvault v11 (Simpana) Cheatsheet

Unified data management and protection platform for enterprise environments.
/ Унифицированная платформа управления и защиты данных для корпоративных сред.

---

## Index / Оглавление
1. [Installation & Configuration / Установка и конфигурация](#installation--configuration--установка-и-конфигурация)
2. [Core Management / Базовое управление](#core-management--базовое-управление)
3. [Sysadmin Operations / Сисадминские операции](#sysadmin-operations--сисадминские-операции)
4. [Security & Auth / Безопасность и аутентификация](#security--auth--безопасность-и-аутентификация)
5. [Performance Tuning / Оптимизация производительности](#performance-tuning--оптимизация-производительности)
6. [Database Protection / Защита баз данных](#database-protection--защита-баз-ных)
7. [Backup & Restore / Бэкап и восстановление](#backup--restore--бэкап-и-восстановление)
8. [Troubleshooting / Поиск и устранение неисправностей](#troubleshooting--поиск-и-устранение-неисправностей)
...
## Core Management / Базовое управление
...
## Sysadmin Operations / Сисадминские операции
...
## Security & Auth / Безопасность и аутентификация
...
## Database Protection / Защита баз данных
...
2.  **Staging:** Commvault creates a temporary dump in the configured staging directory.
    / **Стейджинг:** Commvault создает временный дамп в настроенном катаге стейджинга.
