...
Item {
    ...
    function refreshCheats() {
        ...
        // The script is installed alongside the widget
        if (scriptBasePath === "") {
            // Resolve the base path from the QML file location
        ...
        // Construct command - use bash to ensure proper execution
        var cmd = "bash \"" + scriptPath + "\" \"" + cheatsDir + "\" \"" + debugLog + "\""
        
        // Apply Plasma 6 shield
    ...
    ColumnLayout {
        ...
        PlasmaComponents.Label {
            ...
            Layout.fillWidth: true
             ...
             // Auto clear status after 5s (except errors)
            Timer {
                interval: 5000
